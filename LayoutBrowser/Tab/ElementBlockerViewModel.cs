...
namespace LayoutBrowser.Tab
{
    ...
    public class ElementBlockerViewModel : ObservableObject
    {
        ...
        private readonly ObservableCollection<ElementBlockerRuleItemViewModel> rules = new ObservableCollection<ElementBlockerRuleItemViewModel>();
        ...
        public ElementBlockingSettings ToModel() => new ElementBlockingSettings
        {
            enabled = enabled,
        ...
        {
            var ruleVm = new ElementBlockerRuleItemViewModel(rule.enabled, rule.selector, OnRuleEnabledChanged, OnRuleSelectorChanged, this);
